...
class WidgetInstallRequest extends FormRequest implements DTOable
{
    ...
    public function toDTO(): WidgetInstalledDTO
    {
        ...
        $userDTO = new NewAmoUserDTO(id: Arr::get($data, "id"), api_key: Arr::get($data, "api_key"), amojo_id: Arr::get($data, "amojo_id"), domain: Arr::get($data, "domain"), email: Arr::get($data, "email"), phone: Arr::get($data, "phone"),);

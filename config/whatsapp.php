...
return [
    ...
    'instance' => [
        ...
        /*
         * TODO: Рассмотреть увеличение задержки при высокой нагрузке
         * При большом количестве сообщений рекомендуется увеличить
         * задержку до 5000-10000 мс для обеспечения стабильной обработки.
         * Текущее значение 3000 мс может быть недостаточным.
         */
